...
&& dpkg -r cudnn-local-repo-ubuntu1804-8.6.0.163 && rm -r /var/cudnn-local-repo* \
...
&& dpkg -r nv-tensorrt-local-repo-ubuntu1804-8.5.3-cuda-11.8 && rm -r /var/nv-tensorrt-local-repo-ubuntu1804-8.5.3-cuda-11.8 \
&& cd ${now} \
