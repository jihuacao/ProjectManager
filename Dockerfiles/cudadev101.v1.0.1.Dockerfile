# : 安装cuda开发集cu102
ARG Download
ARG ToolkitName=cuda_10.1.89_440.33.01_linux.run
ARG CUDAToolkit=https://developer.download.nvidia.com/compute/cuda/10.1/Prod/local_installers/${ToolkitName}
ARG ToolkitPatch1=cuda_10.2.1_linux.run
ARG CUDAPatch1=https://developer.download.nvidia.com/compute/cuda/10.1/Prod/patches/1/${ToolkitPatch1}
ARG ToolkitPatch2=cuda_10.2.2_linux.run
ARG CUDAPatch2=https://developer.download.nvidia.com/compute/cuda/10.1/Prod/patches/2/${ToolkitPatch2}
